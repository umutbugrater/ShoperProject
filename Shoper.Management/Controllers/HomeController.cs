    ...
    public class HomeController : Controller
    {
       ...
       // [Authorize(Roles = "manager")]
        ...
        public async Task<IActionResult> Register(registerViewModel model, string ReturnUrl = null)
        {
                ...
                _mailSender.MailSend(new Email()
                {
        ...
        public async Task<IActionResult> Login(loginViewModel model, string ReturnUrl = null)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.ResetAccessFailedCountAsync(user);   //Daha önce girmiş olduğu yanlış sayısını sıfırlıyor
        ...
        [HttpGet]
        [AllowAnonymous]  //herkese izin ver authentication(yetkisi) olanda girer olmayanda
