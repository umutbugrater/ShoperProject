...
builder.Services.AddIdentity<AppUser, IdentityRole>(options =>
{
    ...
    options.Password.RequireDigit = true;  //sayiların olup olmaması
    options.Password.RequiredLength = 6;
    //options.Password.RequiredUniqueChars = 1;  her harftan 1 tane olmayı sağlar
    options.Password.RequireLowercase = true;
    options.Password.RequireUppercase = true;
    //options.Password.RequireNonAlphanumeric = true; //harflerin olup olmaması
...
builder.Services.ConfigureApplicationCookie(_ =>
{
    ...
    _.AccessDeniedPath = new PathString("/Home/AccessDenied");  //İzni yoksa bu sayfaya girecek
});
